...
{\bf Note:} If you use this package please cite Stevens, Jones, and Lefevre (2013).
...
\begin{thebibliography}{80}
 ...
 \bibitem{Stevens2013}
 Stevens J.R., Jones T.R., and Lefevre M.L. (2013),
 ``SigTree:  An Automated Meta-Analytic Approach to Find Significantly Responsive Branches in a Phylogenetic Tree,''
