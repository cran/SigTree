...
{\bf Note:} If you use this package, please cite Stevens \emph{et al.} (2016).
...
\begin{thebibliography}{80}
 ...
 \bibitem{Stevens2016}
 Stevens J.R., Jones T.R., Lefevre M.L., Ganesan B., and Weimer B.C. (2016),
 ``SigTree: a metagenomics tool to identify and visualize significantly responsive branches in a phylogenetic tree,''
