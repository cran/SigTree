...
{\bf Note:} If you use this package, please cite Stevens \emph{et al.} (2014).
...
\begin{thebibliography}{80}
 ...
 \bibitem{Stevens2014}
 Stevens J.R., Jones T.R., Lefevre M.L., Ganesan B., and Weimer B.C. (2014),
 ``SigTree: identifying and visualizing significantly responsive branches in a phylogenetic tree,''
 manuscript submitted December 2014.
